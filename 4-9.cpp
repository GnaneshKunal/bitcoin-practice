...
// Case insensitive comparision with the search string.
bool match_found(const std:: string & address);

int main() {

  // random_device on Linux uses "/dev/urandom"
  // Caution: Depending on implementation this RNG may not be secur enough!
  ...
  while (true) {
    ...
    // Does it match our search string? (1gk)
...
bool match_found(const std::string & address) {
  ...
  // character og the supplied address.
